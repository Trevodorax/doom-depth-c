...
int display_tips_gui(game_window_t * game_window, rect_t container);
int display_tip_gui(game_window_t * game_window, char * key, char * effect, rect_t container);

int display_help_gui(game_window_t * game_window) {
    ...
    display_tips_gui(game_window, stats_container);
...
int display_tip_gui(game_window_t * game_window, char * key, char * effect, rect_t container) {
    ...
    print_text_in_rectangle(
            game_window->renderer,
            rect_to_SDL_Rect(key_container),
            key,
            game_window->sdl_color_palette->text,
            ALIGN_START,
            ALIGN_CENTER
