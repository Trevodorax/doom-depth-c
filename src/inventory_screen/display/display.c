...
int display_inventory(game_window_t * game_window,
    ...
    switch(game_window->ui_type) {
        case CLI:
            return display_inventory_cli(game_window, player, active_section, active_category, active_action, active_item);
        case GUI:
            return display_inventory_gui(game_window, player, active_section, active_category, active_action, active_item);
    }
}
