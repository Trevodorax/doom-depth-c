 ...
 * @param active_section // the section of the user experience the user is in
 * @param active_category // the current category the user has chosen or has their cursor on
 * @return false if the active category is CATEGORIES, true otherwise
 */
 ...
 * @param active_section // the section of the user experience the user is in
 * @return false if there is nothing to display or if there was en error while rendering, true otherwise
 */
